...
public class CashierLoginFormController {
    ...
    public void cashierLogin(ActionEvent actionEvent) throws IOException, SQLException, ClassNotFoundException {
        logOnAction();
    }

    public void logOnAction() throws IOException, SQLException, ClassNotFoundException {
        List<loginDetail> temp = ManageLogin.getDetail(userName, "Reception");
        ...
        for (int i = 0; i < temp.size(); i++) {
            ...
            if (userName.getText().equals(temp.get(i).getUserName())) {
                ...
                if (password.getText().equals(pWod)) {
                    ...
                    AnimateController.setValue("../view/cashierDashBoardForm.fxml", userName.getText());
    ...
    private void notification() {
        ...
        notifications.text("Reception Login Success..");
