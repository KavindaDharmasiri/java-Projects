...
public class UpdateRoomFormController {
    public AnchorPane updateRoomDashBoard;
    ...
    public void updateRoom(ActionEvent actionEvent) throws IOException, SQLException, ClassNotFoundException {
        if (value != null) {
            if (txtRoomType.getText() != null && txtRoomPrice.getText() != null) {
                ...
                ManageRoom.updateRoom(txtRoomId.getText(), txtRoomType.getText(), value, txtRoomPrice.getText());
    ...
    private void back() throws IOException {
        URL resource = getClass().getResource("../view/updateRoomForm.fxml");
        Parent load = FXMLLoader.load(resource);
        Stage window = (Stage) updateRoomDashBoard.getScene().getWindow();
